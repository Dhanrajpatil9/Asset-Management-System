...
<div class="span-24">
<img src="<?php echo WEB_ROOT; ?>images/asset_header1.jpg" width="950"/>
</div>
  ...
  <tr>
	...
	<h2 style="font-size:18px;">User Login</h2>
		<form method="post" name="frmLogin" id="frmLogin">
         ...
         <strong>Name : </strong><input name="txtUserName" type="text" id="txtUserName"  size="10" maxlength="20" ><br><br/>
         <strong>Password : </strong><input name="txtPassword" type="password"  id="txtPassword"  size="10"><br/>
         <br/>  <input name="btnLogin" type="submit" id="btnLogin" value="Login" class="button" border-radius:20px;>
